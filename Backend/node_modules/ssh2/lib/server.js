...
const { init: cryptoInit } = require('ssh2/lib/protocol/crypto.js');
const { KexInit } = require('ssh2/lib/protocol/kex.js');
...
const { writeUInt32BE } = require('ssh2/lib/protocol/utils.js');
