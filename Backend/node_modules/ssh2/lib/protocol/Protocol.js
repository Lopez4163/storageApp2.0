...
const { bindingAvailable, NullCipher, NullDecipher } = require('ssh2/lib/protocol/crypto.js');
const {
  COMPAT_CHECKS,
  DISCONNECT_REASON,
  eddsaSupported,
  ...
  SIGNALS,
  TERMINAL_MODE,
} = require('ssh2/lib/protocol/constants.js');
const {
  ...
  kexinit,
  onKEXPayload,
} = require('ssh2/lib/protocol/kex.js');
const {
  parseKey,
} = require('ssh2/lib/protocol/keyParser.js');
const MESSAGE_HANDLERS = require('ssh2/lib/protocol/handlers.js');
const {
  bufferCopy,
  bufferFill,
  bufferSlice,
...
const {
  ...
  ZlibPacketReader,
  ZlibPacketWriter,
} = require('ssh2/lib/protocol/zlib.js');

const MODULE_VER = require('ssh2/package.json').version;
